...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Ingest files from a directory into a text file.')
    parser.add_argument('directory', help='Directory to scan and ingest files from')
    parser.add_argument('-o', '--output', default=OUTPUT_FILE, help=f'Output file path (default: {OUTPUT_FILE})')
    args = parser.parse_args()
    
    scan_files([args.directory], args.output)
